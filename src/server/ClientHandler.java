...
public class ClientHandler implements Runnable {
    ...
    // 🔥 낮 투표 저장소 (투표자 → 대상) - 각 핸들러에서 자기 방 기준
    ...
    private void handleJoinRoom(String msg) {
        ...
        send("JOIN_OK|" + target.getId() + "|" + target.getName());
    ...
    private void handleNightAction(String msg) {
        ...
        switch (role) {
            ...
            case "POLICE":
                ...
                String team = (targetRole != null && targetRole.equals("MAFIA")) ? "MAFIA" : "CIVIL";
